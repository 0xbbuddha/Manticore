...
// NegotiateFlags is a bitmask of flags that can be set in a NegotiateMessage
type NegotiateFlags uint32

// String returns a string representation of the NegotiateFlags
...
// HasFlag checks if the flag is set in the NegotiateFlags
func (f NegotiateFlags) HasFlag(flag NegotiateFlags) bool {
	return f&flag != 0
}
