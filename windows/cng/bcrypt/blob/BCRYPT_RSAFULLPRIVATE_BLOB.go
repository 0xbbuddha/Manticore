...
func (b *BCRYPT_RSAFULLPRIVATE_BLOB) Unmarshal(value []byte) (int, error) {
	if len(value) < 24 {
	...
	if int(b.Header.CbPrime1) > len(value)-bytesRead {
		return 0, errors.New("buffer too small for BCRYPT_RSAFULLPRIVATE_BLOB, not enough bytes for unmarshalling prime1")
	}
	b.Prime1 = value[bytesRead : bytesRead+int(b.Header.CbPrime1)]
	bytesRead += int(b.Header.CbPrime1)

	// Unmarshalling prime2
	if int(b.Header.CbPrime2) > len(value)-bytesRead {
		return 0, errors.New("buffer too small for BCRYPT_RSAFULLPRIVATE_BLOB, not enough bytes for unmarshalling prime2")
	}
	b.Prime2 = value[bytesRead : bytesRead+int(b.Header.CbPrime2)]
	bytesRead += int(b.Header.CbPrime2)

	// Unmarshalling exponent1
	// if int(b.Header.CbExponent1) > len(value)-bytesRead {
	// 	return 0, errors.New("buffer too small for BCRYPT_RSAFULLPRIVATE_BLOB, not enough bytes for unmarshalling exponent1")
	// }
	// b.Exponent1 = value[bytesRead : bytesRead+int(b.Header.CbExponent1)]
	// bytesRead += int(b.Header.CbExponent1)

	// Unmarshalling exponent2
	// if int(b.Header.CbExponent2) > len(value)-bytesRead {
	// 	return 0, errors.New("buffer too small for BCRYPT_RSAFULLPRIVATE_BLOB, not enough bytes for unmarshalling exponent2")
	// }
	// b.Exponent2 = value[bytesRead : bytesRead+int(b.Header.CbExponent2)]
	// bytesRead += int(b.Header.CbExponent2)

	// Unmarshalling coefficient
	// if int(b.Header.CbCoefficient) > len(value)-bytesRead {
	// 	return 0, errors.New("buffer too small for BCRYPT_RSAFULLPRIVATE_BLOB, not enough bytes for unmarshalling coefficient")
	// }
	// b.Coefficient = value[bytesRead : bytesRead+int(b.Header.CbCoefficient)]
	// bytesRead += int(b.Header.CbCoefficient)
	...
	// }
	// b.PrivateExponent = value[bytesRead : bytesRead+int(b.Header.CbPrivateExp)]
	// bytesRead += int(b.Header.CbPrivateExp)
