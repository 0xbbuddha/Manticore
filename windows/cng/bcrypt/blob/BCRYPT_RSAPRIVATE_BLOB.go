...
func (b *BCRYPT_RSAPRIVATE_BLOB) Unmarshal(value []byte) (int, error) {
	if len(value) < 24 {
		return 0, errors.New("buffer too small for BCRYPT_RSAPRIVATE_BLOB, header too short (at least 24 bytes are required)")
	}
